...
class UsplController extends Controller
{
    public function index()
    {
        ...
        return view('admin.feright.uspackinglist.add', compact('shipments'));
    }
    ...
    public function create($id)
    {
        ...
        return view(
            'admin.feright.uspackinglist.create',
            compact(
                'container',
                'trPackingList',
                'products'
    ...
    public function store(Request $request)
    {
        ...
        if ($existing) {
            return redirect()
                ->route('admin.uspl.edit', $existing->id)
    ...
    public function edit($id)
    {
        ...
        return view(
            'admin.feright.uspackinglist.edit',
            compact('packingList')
        );
    }
    ...
    public function preview($id)
    {
        ...
        return view(
            'admin.feright.uspackinglist.preview',
            compact('packingList')
        );
    }
