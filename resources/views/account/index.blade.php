...
@section('body')
    ...
    <div class="page-header">
        ...
        <a href="{{ route('account.calculation.create') }}"
                    ...
                    @forelse($calculations as $key => $calculation)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('account.calculation.show',$calculation->id) }}"
                                   class="btn btn-info btn-sm">
                                    View
                                </a>

                                <a href="{{ route('account.calculation.edit',$calculation->id) }}"
                                   class="btn btn-warning btn-sm">
                                    Edit
                                </a>

                                <a href="{{ route('account.calculation.exportExcel',$calculation->id) }}"
                                   class="btn btn-success btn-sm">
                                    Excel
                                </a>

                                <form action="{{ route('account.calculation.delete',$calculation->id) }}"
                                      method="POST"
                                      class="d-inline">
