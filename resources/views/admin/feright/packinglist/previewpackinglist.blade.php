        ...
        <div class="card-header">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div>
                    ...
                    <a href="{{ route('trpl.admin.edit',$packingList->id) }}"
                       class="btn btn-warning btn-sm">
                        Edit
                    </a>

                    <a href="{{route('trpl.admin.export.pdf',$packingList->id)}}"
                       class="btn btn-danger btn-sm">
                        PDF
                    </a>

                    <a href="{{ route('trpl.admin.export.excel',$packingList->id) }}"
                       class="btn btn-success btn-sm">
                        Excel
                    </a>
                    <a href="{{ route('trpl.admin.delete',$packingList->id) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this Packing List?')"> Delete </a>
