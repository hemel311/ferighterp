...
@push('js')
    ...
    <script>
        ...
        $('#booking_number').change(function(){
            ...
            $.ajax({
                url: '/admin/us-pl/containers/' + bookingNumber,
                type: 'GET',
                ...
                success:function(response){
                    ...
                    $.each(response,function(index,item){
                        ...
                        if(item.us_packing_lists.length > 0)
                        {
                            let pl = item.us_packing_lists[0];
                        ...
                        `;
                            ...
                            else
                            {
                                ...
                                action = `
                            <a href="/admin/us-pl/preview/${pl.id}"
                        ...
                        else
                        {
                            ...
                            action = `
                        <a href="/admin/us-pl/create/${item.id}"
